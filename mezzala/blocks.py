...
__all__ = ['BaseRate', 'HomeAdvantage', 'TeamStrength', 'KeyBlock', 'HomeBlock', 'AwayBlock', 'ConstantBlock']
...
class KeyBlock(ModelBlockABC):
    ...
    The key function should return a tuple of (parameter key, weight). The
    weight for categorical variables should be 1.0
    """
    ...
    def param_keys(self, adapter, data):
        return list(set(self.key(r)[0] for r in data))
